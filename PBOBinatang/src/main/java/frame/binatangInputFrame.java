...
public class binatangInputFrame extends JFrame {
...
//            }
            ...
            try {
                if (this.id == 0) {
                    String cekSQL = "SELECT * FROM binatang WHERE nama = ?";
                    ...
                    while (rs.next()){
                        JOptionPane.showMessageDialog(
                                null,
                                "Nama Binatang Sudah Ada",
                                "Validasi data sama",
                                JOptionPane.WARNING_MESSAGE
                        );
                        return;
                    }
                    String insertSQL = "INSERT INTO binatang SET nama = ?, id_merk = ?, id_class = ?";
                    ...
                    String cekSQL = "SELECT * FROM binatang WHERE nama=? AND id!=?";
                    ps = c.prepareStatement(cekSQL);
                    ps.setString(1, nama);
                    ps.setInt(2, id);
                    ResultSet rs = ps.executeQuery();
                    ...
                    String updateSQL = "UPDATE binatang SET nama=?, id_class=?, id_merk=? WHERE id=?";
    ...
    public void isiKomponen() {
        ...
        String findSQL = "SELECT * FROM binatang WHERE id = ?";
    ...
    public void classcb() {
        Connection c = Koneksi.getConnection();
        String selectSQL = "SELECT * FROM class ORDER by nama_binatang";
